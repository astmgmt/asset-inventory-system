  ...
  <div class="container" role="main" aria-label="Admin Message">
    ...
    <div class="footer">
      ...
      <p style="font-size: 13px; margin-top: 8px; color: #9ca3af;">
        This is an official message from the system administrators.
      </p>
    </div>
  </div>
</body>
