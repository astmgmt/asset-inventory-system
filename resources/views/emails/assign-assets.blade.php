...
<body>
    <div class="container" role="main" aria-label="Asset Assignment Notification">
        ...
        <h3>✅ Assets Assigned Successfully</h3>

        <div class="content">
            <p>Hello {{ $userName }},</p>
            <p>Your assets have been assigned (Borrow Code: <strong>{{ $borrowCode }}</strong>).</p>

            <div class="notice">
                <div>
                    <p><strong>Assignment Date:</strong> {{ $approvalDate->format('F j, Y g:i A') }}</p>
                    <p class="download-form">Download the Borrower's Accountability Form attached to this email.</p>
                </div>
            </div>
