                ...
                <tbody class="divide-y divide-gray-100 bg-white">
                    @forelse($printLogs as $log)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-2 text-gray-700">{{ $log->date_from ? \Carbon\Carbon::parse($log->date_from)->format('M d, Y') : 'All' }}</td>
                            <td class="px-4 py-2 text-gray-700">{{ $log->date_to ? \Carbon\Carbon::parse($log->date_to)->format('M d, Y') : 'All' }}</td>
