            ...
            <div class="modal">
                ...
                <form wire:submit.prevent="createAssignment">
                    ...
                    <div class="modal-actions">
                        <button type="submit" class="btn btn-primary btn-update">Assign</button>
    ...
    @if ($showViewModal)
        <div class="modal-backdrop">
            <div class="modal">
                ...
                <div class="modal-actions">
                    <button type="button" wire:click="closeModals" class="btn btn-secondary">Close</button>
                </div>
            </div>
        </div>
    @endif
    ...
    @if ($showDeleteModal)
        <div class="modal-backdrop">
            <div class="modal modal-delete">
                ...
                <div class="modal-actions">
                    <button wire:click="deleteAssignment" class="btn btn-danger">Delete</button>
                    <button wire:click="closeModals" class="btn btn-secondary">Cancel</button>
                </div>
            </div>
        </div>
    @endif
