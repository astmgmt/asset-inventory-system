<div class="superadmin-container">
    <h1 class="page-title main-title">My Assets</h1>
        ...
        <div class="overflow-x-auto">
            <table class="user-table">
                ...
                <tbody>
                    @forelse($transactions as $transaction)
                        <tr>
                            ...
                            <td data-label="Status" class="text-center">
                                ...
                                @elseif($transaction->status === 'PartiallyReturned')
                                    <span class="status-badge partially-returned">Partially Returned</span>
                                @endif
                            </td>
                            ...
                            <td data-label="Actions" class="text-center">
                                @php
                                    $borrowedCount = $transaction->borrowItems->where('status', 'Borrowed')->count();
                                    $totalCount = $transaction->borrowItems->count();
                                @endphp
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="no-software-row">No borrowed assets found</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
                            ...
                            <div>
                                ...
                                <p>
                                    @if($selectedTransaction->status === 'Borrowed')
                                        <span class="status-badge borrowed">Borrowed</span>
                                    @elseif($selectedTransaction->status === 'PartiallyReturned')
                                        <span class="status-badge partially-returned">Partially Returned</span>
                                    @endif
                                </p>
                            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mt-6">
                            ...
                            <textarea 
                                ...
                                placeholder="Add any remarks for the return..."
                            ></textarea>
                        </div>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        >
                            <span wire:loading.remove>
                                <i class="fas fa-paper-plane mr-2"></i> Return Selected
                            </span>
                            <span wire:loading>
        ...
        @if($showConfirmationModal)
            <div class="modal-backdrop" x-data="{ show: @entangle('showConfirmationModal') }" x-show="show">
                <div class="modal" x-on:click.away="$wire.showConfirmationModal = false">
                    <div class="modal-header">
                        <h2 class="modal-title">Confirm Asset Return</h2>
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-blue-700">
                                        Do you really want to return the selected assets?
                                    </p>
