<div class="superadmin-container">
    <h1 class="page-title main-title">Asset Printing</h1>
    ...
    <div class="section-wrapper shadow-md rounded-lg p-6 mb-6 border border-gray-200">
        <form wire:submit.prevent="printAssets" class="space-y-6">
            ...
            <div>
                <button 
                    type="submit"
                    class="inline-flex items-center px-5 py-2.5 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition"
                >
